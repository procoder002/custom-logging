...
int main() {
    ...
    logger.addLogDestination("console", new ConsoleLogDestination());  // Log to console
     ...
     */ 
    logger.addLogDestination("logfile", new FileLogDestination("app.log", 2*1024*1024, 3));  // Log to file

    // logger.addLogDestination("netlog", new NetworkLogDestination());  // Simulate network logging
